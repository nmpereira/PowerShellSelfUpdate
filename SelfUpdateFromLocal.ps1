function UpdateSctipt {
    ...
    $ScriptUpdaterFileName = 'SelfUpdateFromLocalFromLocal.ps1'
    ...
    $ScriptUpdaterFileName= 'SelfUpdateFromLocal.ps1'
    ...
    $script:UpdaterPathexe = join-path $CurrentDirectory -childpath 'SelfUpdateFromLocal.exe'
    taskkill /IM SelfUpdateFromLocal.exe /F
